...
public class Forget extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        next.setBackground(new java.awt.Color(74, 31, 61));
        next.setFont(new java.awt.Font("Sitka Small", 3, 12)); // NOI18N
        ...
        jLabel2.setText("Enter Your Username To Know Your Password");
    ...
    private void nextMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_nextMouseClicked
        ...
        try {
            ...
            ResultSet  rs= s.executeQuery(" select username from users where username ="+uu+" " );
            if(rs.next()){
