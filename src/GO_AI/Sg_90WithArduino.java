...
public class Sg_90WithArduino extends javax.swing.JFrame {

    /**
     * Creates new form Sg_90WithArduino
     */
    public Sg_90WithArduino() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Sg_90WithArduino.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Sg_90WithArduino().setVisible(true);
            }
        });
    }
