...
public class IRSensor extends javax.swing.JFrame {

    /**
     * Creates new form IRSensor
     */
    public IRSensor() {
        initComponents();
    ...
    private void jLabel20MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel20MouseClicked
        new GO_AI.IRSensorWithArduino().setVisible(true);
        dispose();
    ...
    private void jLabel21MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel21MouseClicked
        new GO_AI.IRSensorCode().setVisible(true);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IRSensor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
