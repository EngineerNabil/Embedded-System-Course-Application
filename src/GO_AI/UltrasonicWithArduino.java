...
public class UltrasonicWithArduino extends javax.swing.JFrame {

    /**
     * Creates new form UltrasonicWithArduino
     */
    public UltrasonicWithArduino() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UltrasonicWithArduino.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UltrasonicWithArduino().setVisible(true);
            }
        });
    }
