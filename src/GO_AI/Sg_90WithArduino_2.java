...
public class Sg_90WithArduino_2 extends javax.swing.JFrame {

    /**
     * Creates new form Sg_90WithArduino_2
     */
    public Sg_90WithArduino_2() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/GO_AI/SeervoWithjpg.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Sg_90WithArduino_2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Sg_90WithArduino_2().setVisible(true);
            }
        });
    }
