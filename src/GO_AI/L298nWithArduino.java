...
public class L298nWithArduino extends javax.swing.JFrame {

    /**
     * Creates new form L298nWithArduino
     */
    public L298nWithArduino() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel10.setBounds(20, 270, 64, 64);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(L298nWithArduino.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new L298nWithArduino().setVisible(true);
            }
        });
    }
