...
public class Forget extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/GO_AI/IMG-20230319-WA0070.jpg"))); // NOI18N
        jLabel6.setToolTipText("");
        jLabel6.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(235, 235, 235), 2, true));
        ...
        jLabel5.setText("Please Enter Your New Password below");
    ...
    private void signinMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_signinMouseClicked
        ...
        try {
            ...
            int        x = s.executeUpdate(" update users set user_password = "+pp+" where user_email = "+ee+"" );
            if(x != 0){
