...
public class ColorSensorWithArduino extends javax.swing.JFrame {

    /**
     * Creates new form ColorSensorWithArduino
     */
    public ColorSensorWithArduino() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ColorSensorWithArduino.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ColorSensorWithArduino().setVisible(true);
            }
        });
    }
