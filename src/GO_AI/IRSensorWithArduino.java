...
public class IRSensorWithArduino extends javax.swing.JFrame {

    /**
     * Creates new form IRSensorWithArduino
     */
    public IRSensorWithArduino() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IRSensorWithArduino.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IRSensorWithArduino().setVisible(true);
            }
        });
    }
