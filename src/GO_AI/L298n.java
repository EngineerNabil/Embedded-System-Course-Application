...
public class L298n extends javax.swing.JFrame {

    /**
     * Creates new form L298n
     */
    public L298n() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel10.setBounds(20, 260, 64, 64);
    ...
    private void jLabel20MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel20MouseClicked
        new GO_AI.L298nWithArduino().setVisible(true);
        dispose();
    ...
    private void jLabel21MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel21MouseClicked
        new GO_AI.L298nCode().setVisible(true);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(L298n.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
