...
public class ColorSensorCode extends javax.swing.JFrame {

    /**
     * Creates new form ColorSensorCode
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ColorSensorCode.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ColorSensorCode().setVisible(true);
            }
        });
    }
