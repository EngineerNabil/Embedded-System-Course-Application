...
public class IRSensorWithArduino_2 extends javax.swing.JFrame {

    /**
     * Creates new form IRSensorWithArduino_2
     */
    public IRSensorWithArduino_2() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel8);
        jLabel8.setBounds(20, 230, 60, 61);
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/GO_AI/Connection Diagram.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IRSensorWithArduino_2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IRSensorWithArduino_2().setVisible(true);
            }
        });
    }
