...
public class UltrasonicCode extends javax.swing.JFrame {

    /**
     * Creates new form UltrasonicCode
     */
    public UltrasonicCode() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UltrasonicCode.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UltrasonicCode().setVisible(true);
            }
        });
    }
