...
public class ColorSensorCode_2 extends javax.swing.JFrame {

    /**
     * Creates new form ColorSensorCode_2
     */
    public ColorSensorCode_2() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ColorSensorCode_2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ColorSensorCode_2().setVisible(true);
            }
        });
    }
